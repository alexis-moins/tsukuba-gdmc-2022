    ...
    def create_pages(self, lines):
        ...
        for line in lines:
            ...
            if current_length + line_length < BookMaker.MAX_CHARACTERS_PER_PAGE \
                    and current_page < BookMaker.MAX_LINES_PER_PAGE:
...
if __name__ == '__main__':
    text = "Year 1\n my name is Youri and I hope it will work from the first try\n\nYear 2\nI believe I should put on some character here to try to fill up a whole page with plain text and see how it react you shouldnt lose a single word !\n\nYear 3\nSo did it worked ?"
